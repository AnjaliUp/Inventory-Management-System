...
class BillClass: 
    def __init__(self, root):
        ...
        self.root.title("Logistics Management System | Developed by Anjali Upadhyay, Ashish Patel, Abhijit Tiwari")
        ...
        #==============Footer============
        footer=Label(self.root,text="Logistics Management System | Developed by Anjali Upadhyay",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.show()
        # self.bill_top()
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tUpadhyay-Logistics
\t Phone no. 6392270881, Udaipur-313601
{str("="*47)}
