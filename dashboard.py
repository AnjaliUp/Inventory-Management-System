...
class IMS: 
    def __init__(self, root):
        ...
        self.root.title("Inventory Management System | Developed by Anjali Upadhyay, Ashish Patel, Abhijit Tiwari")
        ...
        #==footer===
        lbl_footer = Label(self.root, text="IMS- Inventory Management System | Developed by Anjali, Ashish,  Abhijit\n For any Technical Issue Contact: 6392270881", font=("times new roman", 12), bg="#4d636d", fg="white").pack(side=BOTTOM, fill=X)
        self.update_content()
